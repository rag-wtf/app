...
void main() {
  group('InfiniteList', () {
    ...
    testWidgets('attempts to fetch new elements if rebuild occurs '
        'with different set of items', (tester) async {
    ...
    testWidgets('passes padding to internal SliverPadding', (tester) async {
    ...
    testWidgets('uses media query padding when padding is omitted', (
      tester,
    ) async {
    ...
    testWidgets('renders separators in between items using separatorBuilder', (
      tester,
    ) async {
      const itemCount = 20;
    ...
    testWidgets('forward the correct indexes to separatorBuilder', (
      tester,
    ) async {
      const itemCount = 20;
      final indexes = <int>[];
    ...
    group('with an empty set of items', () {
      testWidgets('renders no list items by default', (tester) async {
        await tester.pumpApp(
          InfiniteList(
            itemCount: 0,
            onFetchData: emptyCallback,
      ...
      testWidgets('renders custom emptyBuilder', (tester) async {
        const key = Key('__test_target__');
    ...
    group('with hasError set to true', () {
      testWidgets('renders default errorBuilder', (tester) async {
        await tester.pumpApp(
          InfiniteList(
            hasError: true,
            itemCount: 0,
      ...
      testWidgets('renders custom errorBuilder', (tester) async {
        const key = Key('__test_target__');
    ...
    group('with isLoading set to true', () {
      testWidgets('renders default loadingBuilder', (tester) async {
        await tester.pumpApp(
          InfiniteList(
            isLoading: true,
            itemCount: 3,
      ...
      testWidgets('renders custom loadingBuilder', (tester) async {
        const key = Key('__test_target__');
