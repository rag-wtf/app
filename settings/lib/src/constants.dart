...
const embeddingsDimensionKey = 'EMBEDDINGS_DIMENSION';
const embeddingsApiBatchSizeKey = 'EMBEDDINGS_API_BATCH_SIZE';
const similaritySearchTypeKey = 'SIMILARITY_SEARCH_TYPE';
const similaritySearchIndexKey = 'SIMILARITY_SEARCH_INDEX';
